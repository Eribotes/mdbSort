...
from mdbSortDemo1Parameters import MdbSortDemo1Parameters
from mdbSortDemo1Display import    MdbSortDemo1Display
...
if __name__ == '__main__':
  ...
  params= MdbSortDemo1Parameters(parameterList)
  ...
  mdbSortData= MdbSortData('DEMO1', '', params.numElements, params.initialOrder)
  ...
  # Get the window dims
  winSize= int(params.numElements)
  ...
  display= MdbSortDemo1Display(winSize, 'mdbSortDemo1')
